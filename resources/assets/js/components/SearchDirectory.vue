<template>
    <main class="grid-x grid-margin-x listing-filters" :class="{ 'filters-active' : showFilters }">
        ...
        <div class="cell large-8">
            <SearchResults type="directory" favtype="Listing"></SearchResults>
        </div>
    </main>
</template>
...
<script>
    ...
    import FilterSlug from './FilterSlug.vue';
    ...
    export default {
        ...
        components: { Typeahead, PostcodeSearch, DistanceSearch, FilterSlug, FilterTag, SearchResults },

        data() {
            return {
                distances: [
                    { id: 1, niceName: 'Within 5 miles', distance: 5, name: 'less_5', checked: '' },
                    { id: 2, niceName: '10 miles', distance: 10, name: 'upto_10', checked: '' },
                    { id: 3, niceName: '25 miles', distance: 25, name: 'upto_25', checked: '' },
                    { id: 4, niceName: '50 miles', distance: 50, name: 'upto_50', checked: true },
                ],
