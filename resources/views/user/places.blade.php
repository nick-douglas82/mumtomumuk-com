        ...
        <section class="user__content has-activity">
            ...
            <div class="user__content-wrap">
                ...
                <main class="content events overflow">
                    @if ($events->count() > 0)
                        @include("user.partials.events.places")
                    @else
                        <div class="feed__empty">
                            <p>There are no places saved yet...</p>
                            <p>Visit the <a href="{{ url(Request::segment(1)) }}/places">places section</a> to see if anything takes your fancy!</p>
                        </div>
                    @endif
                </main>
