...
Class WpApiPlace
{
    ...
    {
        $found = Place::where('wp_id', $data->id)->first();
    ...
    {
        echo "Update Place" . $data->id . " ";
        $post = Place::find($foundPost->id);
        $post->delete();
        $post->seo()->delete();
